...
public class DatabaseManager {
 ...
 sql = "INSERT INTO " + ORDERS_TABLE + " (order_id, player_uuid, commodity_id, order_type, price_per_unit, " +
 ...
 sql = "INSERT OR REPLACE INTO " + ORDERS_TABLE + " (order_id, player_uuid, commodity_id, order_type, price_per_unit, " +
 "amount, filled_amount, created_at, updated_at, active) " +
 "VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?)";
 }
 ...
 plugin.getLogger().warning("Failed to update order status: " + e.getMessage());
 }
 }, executor);
 }
